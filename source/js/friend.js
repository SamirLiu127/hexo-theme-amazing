...
$(function () { //获取处理友链数据
    $.getJSON("../json_data/friend.json", function (data) {
        ...
        $('.links-content').append("<div class='friend-title-item'><br>大哥們<br><br><hr></div>");
        $.each(data, function (i, e) {
            var html = "<div class=\"friend-card-item\">";
            if (e.src == undefined) {
                html += "    <img class=\"ava\" src=\"/img/links/nopic.jpg\" title=\"圖片鏈接不可用，使用的默認圖片\">";
            } else {
        ...
        if (notValid.length > 0) {
            $('.links-content').append("<div class='friend-title-item'><br>異常的大哥們<br><br><hr></div></div>");
